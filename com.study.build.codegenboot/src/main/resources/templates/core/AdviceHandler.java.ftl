...
<String> errors = new ArrayList<>();
    Set
    <ConstraintViolation
    <?>> violations = bindException.getConstraintViolations();
    ...
    */
    ...
    public Result parameterException(List
    <FieldError> fieldErrors) {
        List
        <String> errors = new ArrayList<>();

            // List
            <FieldError> fieldErrors = bindException.getBindingResult().getFieldErrors();
