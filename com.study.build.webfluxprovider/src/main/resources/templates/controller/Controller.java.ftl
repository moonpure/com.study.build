...
class ${entityName}Controller {
   ...
   ${entityName}ServiceImpl ${entityNameLower}Service;
    ...
    public  Mono<Result<${entityName}>> getByName(@PathVariable("name") String name) {

        return Mono.justOrEmpty(${entityNameLower}Service.getByName(name));
    }
    @PostMapping("/getone")
    public  Mono<Result<${entityName}>> getOne(@RequestBody ${entityName} entity) {
    ...
    @PutMapping("/delid/{id}")
    public  Mono<Result<Boolean>> delById(@PathVariable("id") Long id) {
        return Mono.justOrEmpty(${entityNameLower}Service.delById(id));
    }
    @PostMapping("/delids")
    public  Mono<Result<Boolean>> delByIds(@RequestBody List<Long> ids) {
