...
<#list tableColumns as column>
    ...
    <#else>
        ...
        webTestClient.post().uri("/${entityNameLower}/save")
...
<#list tableColumns as column>
        ...
        webTestClient.post().uri("/${entityNameLower}/updateid")
            .body(Mono.just(entity), entity.getClass())
            .exchange()
            .expectStatus().isOk()
         .expectBody().jsonPath("$.code").isEqualTo(0);
    ...
    void getById() throws Exception {
        Long id = 112345l;
        webTestClient.get().uri("/${entityNameLower}/getid/" + id)
            .exchange()
            .expectStatus().isOk()
            .expectBody().jsonPath("$.code").isEqualTo(0);
    }
   @Test
    void getByName() throws Exception {
        String name="test";
        webTestClient.get().uri("/${entityNameLower}/getname/" + name)
            .exchange()
            .expectStatus().isOk()
            .expectBody().jsonPath("$.code").isEqualTo(0);
    }
...
<#list tableColumns as column>
        ...
        webTestClient.post().uri("/${entityNameLower}/getone")
            .body(Mono.just(entity), entity.getClass())
            .exchange()
            .expectStatus().isOk()
            .expectBody().jsonPath("$.code").isEqualTo(0);
...
<#list tableColumns as column>
        ...
        webTestClient.post().uri("/${entityNameLower}/select")
...
<#list tableColumns as column>
        ...
        webTestClient.post().uri("/${entityNameLower}/selectin")
    ...
    void delById() throws Exception {
        Long id=0l;
        webTestClient.put().uri("/${entityNameLower}/delid/" + id)
            .exchange()
            .expectStatus().isOk()
            .expectBody().jsonPath("$.code").isEqualTo(0);
    }
    ...
    void delByIds() throws Exception{
        ...
        webTestClient.post().uri("/${entityNameLower}/delids")
