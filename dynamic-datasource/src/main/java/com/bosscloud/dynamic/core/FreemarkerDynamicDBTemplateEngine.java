...
public class FreemarkerDynamicDBTemplateEngine extends AbstractDynamicDBTemplateEngine {
    private Configuration configuration;

    public FreemarkerDynamicDBTemplateEngine() {
    }

    public FreemarkerDynamicDBTemplateEngine init(ConfigBuilder configBuilder) {
